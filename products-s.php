                    ...
                    <div class="s_p_right_area">
                        ...
                        <div class="s_w_item_area">
                            <div class="s_w_item_area_view">
                                <x>s</x>
                                <div>
                                    <a class="s_w_item_area_view_deactive" href="products"><i class="fa fa-grip-lines"></i></a>
                                    <a class="s_w_item_area_view_active" href="products-s"><i class="fa fa-grip-vertical"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="s_sc-xl-6 s_sc-lg-12 s_sc-md-6 s_sc-sm-6 s_sc-xs-12">
                                    <div class="s_spec_item s_spec_border">
                                        <div class="row">
                                            <div class="s_sc-lg-5 s_sc-lg-4 s_sc-md-5 s_sc-sm-12 s_sc-xs-12">
                                                <a href=""><img class="s_spec_img" src="s-items/00.jpg" alt=""></a>
                                            </div>
                                            <div class="s_sc-xl-7 s_sc-lg-7 s_sc-md-7 s_sc-sm-12 s_sc-xs-12">
